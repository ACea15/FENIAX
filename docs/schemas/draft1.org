...
| Type        | Target | Gravity    | BC1        | ModalAero | SteadyAero   | UnsteadyAero | Point loads | Nonlinearities         | residualised |
|-------------+--------+------------+------------+-----------+--------------+--------------+-------------+------------------------+--------------|
| 1 static    | Level  | False: "g" | Clamped    | None      | None         | None         | None        | All -> ""              | None -> ""   |
| 2 Dynamic   | TRIM   | True: "G"  | Free       | Rogers    | qalpha       | gust         | follower    | Linear sys -> "l"      | True -> "r"  |
