...
#+begin_src python  :results value file :exports results
    ...
    f = config_simo45f.systems.mapper['s1'].xloads.follower_interpolation[0][1:]
...
#+begin_src python : :exports results :results value file
  ...
  annotations.append(dict(#xref='paper',
      ...
      font=dict(family='Arial',
                size=12),
      showarrow=False))
  loads = [f"Load: {li} N" for li in config_simo45d.systems.mapper['s1'].xloads.follower_interpolation[0][1:]]
  for i in range(11):
      line_settings=dict(mode="lines+markers",
                         #marker_symbol="218",
                         line=dict(color=colors[i],
