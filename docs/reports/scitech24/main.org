...
* Run models :noexport:
:PROPERTIES:
:header-args: :var name=(org-element-property :name (org-element-context)) :mkdirp yes :eval (print Veval_blocks)
:END:
** ArgyrisBeam
*** Run
:PROPERTIES:
...
#+NAME: ArgyrisBeam
#+begin_src python :session py1 :mkdirp yes :noweb yes  :results none
...
*** Plot
:PROPERTIES:
:header-args: :tangle ./results/plot_ArgyrisBeam.py
:END:
...
**** Run
:PROPERTIES:
:header-args: :eval (print Veval_blocks_run) :tangle ./results/run_Simo45BeamFollower.py
:END:

#+NAME: Simo45Follower
#+begin_src python :session py1 :tangle ./results/run_Simo45Follower.py :mkdirp yes :noweb yes  :results none :exports results
  <<PYTHONMODULES>>
  <<Simo45Beam>>
  inp.driver.sol_path = pathlib.Path(
      f"./{name}")
...
**** Plot
:PROPERTIES:
:header-args: :tangle ./results/plot_Simo45BeamFollower.py
:END:
...
**** Run
:PROPERTIES:
:header-args: :eval (print Veval_blocks_run) :tangle ./results/run_Simo45BeamDead.py
:END:
...
**** Plot
:PROPERTIES:
:header-args: :tangle ./results/plot_Simo45BeamDead.py
:END:
...
*** Run
:PROPERTIES:
:header-args: :eval (print Veval_blocks_run) :tangle ./results/run_wingSP.py
:END:
...
*** Plot
:PROPERTIES:
:header-args: :tangle ./results/plot_wingSP.py
:END:
...
** XRF1
:PROPERTIES:
:header-args: :mkdirp yes :var name=(org-element-property :name (org-element-context))
:END:
...
*** 2
#+NAME: Gust2
#+begin_src python :session py1  :noweb yes :results none
  <<PYTHONMODULES>>
  <<GustInput>>
  inp.driver.sol_path = pathlib.Path(
      f"./{name}")
...
#+NAME: Gust3
#+begin_src python :session py1  :noweb yes :results none  :eval (print Veval_blocks_run) :tangle ./results/run_XRF1_G3.py
  <<PYTHONMODULES>>
  <<GustInput>>
  inp.driver.sol_path = pathlib.Path(
      f"./{name}")
...
#+NAME: Gust4
#+begin_src python :session py1 :eval (print Veval_blocks_run) :tangle ./results/run_XRF1_G4.py :noweb yes :results none
  <<PYTHONMODULES>>
  <<GustInput>>
  inp.driver.sol_path = pathlib.Path(
      f"./{name}")
...
*** data analysis
:PROPERTIES:
:header-args: :tangle ./results/plot_XRF1.py
:END:
...
#+NAME: Gust3Plot_x
#+begin_src python :session py1 :results value file :exports results :dir results
  gscale = 100./33.977
  figname = f"figs/{name}.png"
...
#+NAME: wingSP_z
#+CAPTION: Span-normalised tip displacements in the dynamic simulation
#+RESULTS: wingSP_z
...
#+CAPTION: Residual $\alpha_1$ and $\alpha_2$ in previous and current implementation
