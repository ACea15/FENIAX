#+TITLE: Differentiable Aeroelastic Framework Suitable for Industrial-Scale Nonlinear Loads on Modern Hardware Architectures
...
# #+TITLE: A nonlinear aeroelastic framework suitable for industrial-scale computation of dynamic loads
