#+TITLE: Differentiable and Nonlinear Aircraft Loads at Large Scale Using an Accelerator-Based Concurrent Solution
# A Concurrent Accelerator-Based Framework for Differentiable and Nonlinear Aircraft Loads at Scale
# Differentiable-Parallel Aircraft Nonlinear Loads at Large Scale Using an Accelerator-Based Solution
...
*** Differentiable-parallel load cases
...
[fn:1] Such is the case that Yann LeCun, one of the fathers of AI, has called for Differentiable programming to supersede Deep Learning in the jargon.
