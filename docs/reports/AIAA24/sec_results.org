...
#+begin_src python :results none  :var name=(org-element-property :name (org-element-context)) figfmt=(print Vpics)
  ...
  @fig_background
  def plot_ra(t, ra,  dim, ra0=[0.,0.,0.], labels=None, node=150,
      ...
      for i, rai in enumerate(ra):
          ...
          fig = uplotly.lines2d(x1, (y1 - ra0[dim]) * scale, fig,
  ...
  def subplots_ra(fun, *args, **kwargs):
...
#+begin_src python :results value file  :var name=(org-element-property :name (org-element-context))
  ...
  labels = ["G1-NL", "G1-Lin", "G2-NL", "G2-Lin"]
  fig, figname = fig_out(name)(subplots_ra)(plot_ra, t, ra, labels=labels, node=150, scale=1./33.977, x_range=[0,1])
  figname
#+end_src
...
#+begin_src python :results value file  :var name=(org-element-property :name (org-element-context))
  ...
  X2.append(solxrf1gust2l.data.dynamicsystem_s2.X2)
  labels = ["G1-NL", "G1-Lin", "G2-NL", "G2-Lin"]
  fig, figname = fig_out(name)(plot_ra)(t, X2, dim=2, labels=labels, node=4, scale=1., x_range=[0,1])
  figname
#+end_src
