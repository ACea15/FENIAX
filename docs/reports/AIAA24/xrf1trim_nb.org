...
#+INCLUDE: "./runs.org::*XRF1trim1" :only-contents t
#+INCLUDE: "./runs.org::*XRF1trim-runs" :only-contents t
#+INCLUDE: "./runs.org::*XRF1-gust" :only-contents t
...
#+INCLUDE: "./sec_examples.org::*XRF1" :only-contents t
