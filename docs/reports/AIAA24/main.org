...
\label{eq2:sol_qs}
\begin{split}
\dot{\pmb{q}}_{1} &=  \pmb{\omega} \odot  \pmb{q}_{2} - \pmb{\Gamma}_{1} \overset{1}{\bullet} \left(\pmb{q}_{1} \otimes \pmb{q}_{1} \right) - \pmb{\Gamma}_{2} \overset{1}{\bullet} \left( \pmb{q}_{2} \otimes  \pmb{q}_{2} \right) + \bm{\eta}  \\
\dot{\pmb{q}}_{2} &= -\pmb{\omega} \odot \pmb{q}_{1} + \pmb{\Gamma}_{2} \overset{2}{\bullet} \left( \pmb{q}_{1} \otimes  \pmb{q}_{2} \right)
\end{split}
\end{equation}
#+end_export
...
where $\lo_1$ and $\lo_2$ are linear operators.
...
\label{eq2:sol_qs}
\begin{split}
\dot{\pmb{q}}_{1} &=  \hat{\pmb{\Omega}}  \pmb{q}_{2} - \hat{\pmb{\Gamma}}_{1} \overset{1}{\bullet} \left(\pmb{q}_{1} \otimes \pmb{q}_{1} \right) - \hat{\pmb{\Gamma}}_{2} \overset{1}{\bullet} \left( \pmb{q}_{2} \otimes  \pmb{q}_{2} \right) + \hat{\bm{\eta}}  \\
\dot{\pmb{q}}_{2} &= -\hat{\pmb{\Omega}} \pmb{q}_{1} + \hat{\pmb{\Gamma}}_{2} \overset{2}{\bullet} \left( \pmb{q}_{1} \otimes  \pmb{q}_{2} \right) \\
