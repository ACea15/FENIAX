...
[[file:~/projects/FENIAX.examples/XRF1trim/NASTRAN/runs/XRF1-144trim1g.f06::ID LABEL TYPE TRIM STATUS VALUE OF UX][go to f06]]
...
** run times :noexport:
GPU:
xrf1gust1,49.93000912666321
xrf1gust1lin,17.80385947227478
xrf1gust2,46.250757694244385
xrf1gust2lin,17.578747510910034
CPU:
xrf1gust1,79.32493233680725
xrf1gust1lin,31.23710012435913
xrf1gust2,82.16147875785828
xrf1gust2lin,33.10497808456421
...
#+NAME: fig:FFBtimes
#+CAPTION: Performance CPU vs GPU comparison in free-flying structure (variable time step)
...
Fig. [[fig:xrf1gust_tip][fig:xrf1gust_tip]] presents the time evolution of the wing-tip normalised displacements and the differences between the linear and nonlinear analysis.   
...
Finally the trim and peek of the gust states are displayed in Fig. [[xrf1_trimgust]].
#+NAME: fig:xrf1_trimgust
