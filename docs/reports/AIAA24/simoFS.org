...
Verifying the nonlinear structural dynamics on a free-free configuration.
...
#+INCLUDE: "./runs.org::*SimoFSpaguetti" :only-contents t
...
#+INCLUDE: "./sec_examples.org::*H-simoFS" :only-contents t

*** Unsupported dynamics of very flexible structure
#+INCLUDE: "./sec_examples.org::*Unsupported dynamics of very flexible structure" :only-contents t
