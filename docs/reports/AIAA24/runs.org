...
#+begin_src python :results none :var name=(org-element-property :name (org-element-context))
  ...
  inp.systems.sett.s1.aero.B = jnp.load(examples_folder / "XRF1trim" / f"NASTRAN/AERO/AICsQhx{inp.fem.num_modes}-000.npy")
...
#+begin_src python :results none :var name=(org-element-property :name (org-element-context)) :tangle ./results/runs.py 
  ...
  inp.systems.sett.s2.aero.A = examples_folder / "XRF1trim" / f"NASTRAN/AERO/AICsQhh{inp.fem.num_modes}-000_8r{inp.fem.num_modes}.npy"
