...
#+INCLUDE: "./runs.org::*SailPlane" :only-contents t
...
# #+INCLUDE: "./sec_examples.org::*Common" :only-contents t
#+INCLUDE: "./sec_examples.org::*H-SailPlane" :only-contents t
*** Load Nastran data
#+INCLUDE: "./sec_examples.org::*N-SailPlane" :only-contents t
*** Structural verification of a representative configuration
**** Geometrically nonlinear static response
#+INCLUDE: "./sec_examples.org::*Geometrically nonlinear static response" :only-contents t
**** Differentiation of static response
#+INCLUDE: "./sec_examples.org::*Differentiation of static response" :only-contents t
