...
#+INCLUDE: "./runs.org::*wingSP" :only-contents t
...
#+INCLUDE: "./sec_examples.org::*H-wingSP" :only-contents t
*** Load Nastran data
#+INCLUDE: "./sec_examples.org::*N-wingSP" :only-contents t
*** Structural verification of a representative configuration
**** Large-amplitude nonlinear dynamics
#+INCLUDE: "./sec_examples.org::*Large-amplitude nonlinear dynamics" :only-contents t
**** Differentiation of dynamic response
#+INCLUDE: "./sec_examples.org::*Differentiation of dynamic response" :only-contents t
