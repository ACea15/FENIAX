...
def build_RBE3(bdf: BDF) -> RBE3:
    ...
    for k, v in bdf.rigid_elements.items():
        if v.type == "RBE3":
            inodes, dnode, inodes_coord, dnodes_coord = extract_RBE3(
                bdf, element=v)
            rbe3_elems.append(k)
...
if (__name__ == "__main__"):
    ...
    bdf = BDF()
    bdf.read_bdf("/media/acea/work/projects/FEM4INAS/examples/wingSP/NASTRAN/wing400d.bdf")
