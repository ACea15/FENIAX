...
import fem4inas.systems.sollibs.diffrax as libdiffrax
...
def main_30g11_1(inputs, # alpha
    ...
    # q = _solve(dq_static.dq_10g11, t_loads, q0, dq_args, config.system.solver_settings)
    q = _solve(newton, dq_static.dq_10g11, t_loads, q0, dq_args, config.system.solver_settings)
    q2 = q[:, q2_index]
