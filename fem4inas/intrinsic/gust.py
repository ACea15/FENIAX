...
def _getGAFs(D0hat,  # NbxNm
    ...
    Ql_wdot = jnp.tensordot(D3hat,  # NpxNmxNb
                            gust_dot,  # NbxNt
                            axes=(2,0))  # NpxNmxNt
...
class GustRogerMc(Gust):
    ...
    def _define_eta(self):
        ...
        (self.Q_w, self.Q_wdot, self.Q_wddot,
        self.Q_wsum, self.Ql_wdot) = _getGAFs(self.solaero.D0hat,  # NbxNm
                                              self.solaero.D1hat,         
                                              self.solaero.D2hat,         
                                              self.solaero.D3hat,         
                                              self.gust,                  
