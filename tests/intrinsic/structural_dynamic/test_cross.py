...
class TestCrossBeam:
    ...
    def sol(self):
        ...
        label = 'm1'
        inp.fem.Ka_name = file_path / f"../../../examples/CrossBeam/FEM/Ka_{label}.npy"
        inp.fem.Ma_name = file_path / f"../../../examples/CrossBeam/FEM/Ma_{label}.npy"
        inp.fem.eig_names = [file_path / f"../../../examples/CrossBeam/FEM/eigenvals_{label}.npy",
                            file_path / f"../../../examples/CrossBeam/FEM/eigenvecs_{label}.npy"]
        inp.fem.grid = file_path / f"../../../examples/CrossBeam/FEM/structuralGrid_{label}"        
    ...
    @pytest.fixture
    def data(self):
        sol_path = file_path / "data/CrossBeam"
