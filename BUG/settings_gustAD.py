...
inp.system.aero.gust.intensity = 3.
inp.system.aero.gust.length = 50.
...
inp.driver.sol_path = pathlib.Path(
    f"{results_path}/gust_AD")

inp.system.aero.gust.fixed_discretisation = [150, u_inf]
solnad = feniax.feniax_main.main(input_dict=inp)


node = 12
inp.system.ad = dict(inputs=dict(length = inp.system.aero.gust.length,
                                 intensity = inp.system.aero.gust.intensity,
                                 u_inf=u_inf,
                                 rho_inf = rho_inf),
                               input_type="gust1",
                               grad_type="jacrev",
...
epsilon = 1e-3
inp.system.ad = dict(inputs=dict(length = inp.system.aero.gust.length + epsilon,
                                 intensity = inp.system.aero.gust.intensity,
                                 u_inf=u_inf,
                                 rho_inf = rho_inf),
                               input_type="gust1",
...
epsilon = 1e-2
inp.system.ad = dict(inputs=dict(length = inp.system.aero.gust.length,
                                 intensity = inp.system.aero.gust.intensity + epsilon,
                                 u_inf=u_inf,
                                 rho_inf = rho_inf),
                               input_type="gust1",
                               grad_type="value",
