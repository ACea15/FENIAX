...
# set1x.append([])
#sh
r0c = np.array([9.37,-2.491])
rc = np.linalg.norm(np.array([10.987,-1.821])-r0c)

pr1=[]
for i in range(3,8+3):
    pr1.append(r0c+rc*np.array([np.cos(2*np.pi/360*(22.5+i*45)),np.sin(2*np.pi/360*(22.5+i*45))]))


##########################################    
p1.append([27.088,pr1[0][0],pr1[0][1]])
x12.append(6.198)
p4.append([27.088,pr1[1][0],pr1[1][1]])
x43.append(6.198)
nspan.append(2)
nchord.append(12)
...
##########################################
##########################################    
p1.append([27.088,pr1[1][0],pr1[1][1]])
x12.append(6.198)
p4.append([27.088,pr1[2][0],pr1[2][1]])
x43.append(6.198)
nspan.append(2)
nchord.append(12)
set1x.append([999098, 999166,9380001])
...
##########################################
##########################################    
p1.append([27.088,pr1[2][0],pr1[2][1]])
x12.append(6.198)
p4.append([27.088,pr1[3][0],pr1[3][1]])
x43.append(6.198)
nspan.append(2)
nchord.append(12)
set1x.append([999098, 999166,9380001])
...
##########################################
##########################################    
p1.append([27.088,pr1[3][0],pr1[3][1]])
x12.append(6.198)
p4.append([27.088,pr1[4][0],pr1[4][1]])
x43.append(6.198)
nspan.append(2)
nchord.append(12)
set1x.append([999098, 999166,9380001])
...
##########################################
##########################################    
p1.append([27.088,pr1[4][0],pr1[4][1]])
x12.append(6.198)
p4.append([27.088,pr1[5][0],pr1[5][1]])
x43.append(6.198)
nspan.append(2)
nchord.append(12)
set1x.append([999098, 999166,9380001])
...
##########################################
##########################################    
p1.append([27.088,pr1[5][0],pr1[5][1]])
x12.append(6.198)
p4.append([27.088,pr1[6][0],pr1[6][1]])
x43.append(6.198)
nspan.append(2)
nchord.append(12)
set1x.append([999098, 999166,9380001])
...
##########################################
##########################################    
p1.append([27.088,pr1[6][0],pr1[6][1]])
x12.append(6.198)
p4.append([27.088,pr1[7][0],pr1[7][1]])
x43.append(6.198)
nspan.append(2)
nchord.append(12)
set1x.append([999098, 999166,9380001])
...
##########################################
##########################################    
p1.append([27.088,pr1[7][0],pr1[7][1]])
x12.append(6.198)
p4.append([27.088,pr1[0][0],pr1[0][1]])
x43.append(6.198)
nspan.append(2)
nchord.append(12)
set1x.append([999098, 999166,9380001])
...
##########################################
#spylon
p4.append([30.062,9.37,-0.393])
x12.append(6.198)
p1.append([30.062,9.37,-0.874])
x43.append(6.198)
nspan.append(2)
nchord.append(4)
set1x.append([999098, 999166,9380001])
...
l1=np.around((70.166-68.1)/(70.81-68.1)*5.028,4)
x12.append(l1)
p4.append([69.12,9.702,2.599])
l2=np.around((70.166-68.1)/(70.81-68.1)*2.019,4)
x43.append(l2)
nspan.append(10)
nchord.append(6)
...
#htp_elevator
p1.append([63.299+l1,0.925,1.585])
x12.append(5.028-l1)
p4.append([69.12+l2,9.702,2.599])
x43.append(2.019-l2)
nspan.append(10)
nchord.append(2)
set1x.append([999004, 999021, 999022, 999023, 999024, 999025, 999026, 999027, 999028, 999029])
...
h1=np.array([63.299+l1,0.925,1.585])
h2=np.array([69.12+l2,9.702,2.599])
hy = (h2-h1)/np.linalg.norm(h2-h1)
hz=np.cross(np.eye(3)[0],hy)/np.linalg.norm(np.cross(np.eye(3)[0],hy))
hx=np.cross(hy,hz)

h1l=np.array([63.299+l1,-0.925,1.585])
h2l=np.array([69.12+l2,-9.702,2.599])
hyl = (h2l-h1l)/np.linalg.norm(h2l-h1l)
hzl=np.cross(np.eye(3)[0],hyl)/np.linalg.norm(np.cross(np.eye(3)[0],hyl))
hxl=np.cross(hyl,hzl)
