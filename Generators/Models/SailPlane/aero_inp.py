...
###
##############InnerWingR#######################
point_LE1, l1 = wb2w(point_le=[3.94, 0, 0.231],
                     x_te=8.49,
                     z_bottom=-0.49,
                     pct2le=0.15,
                     pct2te=0.6)
point_LE2, l2 = wb2w(point_le=[3.94, 2.793, 0.231],
                     x_te=8.49,
                     z_bottom=-0.49,
                     pct2le=0.15,
                     pct2te=0.6)
...
##################OuterWingR#####################
point_LE1, l1 = wb2w(point_le=[3.94, 2.793, 0.231],
                     x_te=8.49,
                     z_bottom=-0.49,
                     pct2le=0.15,
                     pct2te=0.6)
point_LE2, l2 = wb2w(point_le=[19.23, 28.8, -0.304],
                     x_te=20.47,
                     z_bottom=-0.455,
                     pct2le=0.15,
                     pct2te=0.6)
