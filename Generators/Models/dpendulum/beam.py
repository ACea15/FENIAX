...
Area=[rho[0]*L[0]*(I1[0]+I2[0])/(I1m[0]*L[0]) for i in range(NumBeams)]
...
if conm1:
  pass
if conm2:
  mass = [[[80./24,80./8][i] for j in range(N[i])] for i in range(NumBeams)]
  I11 = [[1e-6 for j in range(N[i])] for i in range(NumBeams)]
  I22 = [[1e-6 for j in range(N[i])] for i in range(NumBeams)]
  I33 = [[1e-6 for j in range(N[i])] for i in range(NumBeams)]
