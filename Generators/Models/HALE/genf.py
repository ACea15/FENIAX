...
if run_AICs:
    ...
    for mi in machs:
        ...
        #pdb.set_trace()
        m4.write_modes('HaleX1',V.NumModes,1,m4.inp.feminas_dir+'/Models'+'/'+ m4.inp.model+'/variablesrb.py',m4.inp.feminas_dir+'/Models'+'/'+ m4.inp.model)
