...
from feniax.preprocessor.utils import dfield, initialise_Dclass, dump_inputs
from feniax.preprocessor.inputs import Config, dump_to_yaml
...
df = pd.read_csv(
    "/home/ac5015/programs/FEM4INAS/examples/ArgyrisBeam/FEM/structuralgrid",
    comment="#",
    sep=" ",
...
data_container = importlib.import_module(
    "data_container", "fem4inas.preprocessor.containers"
)
intrinsicmodal = importlib.import_module(
    "intrinsicmodal", "fem4inas.preprocessor.containers"
)
