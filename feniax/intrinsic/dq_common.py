...
def f_12aero(omega, gamma1, gamma2, q1, q2, A2hat):
    _F1 = omega * q2 - contraction_gamma1(gamma1, q1) - contraction_gamma2(gamma2, q2)
    F1 = A2hat @ _F1
    F2 = -omega * q1 + contraction_gamma3(gamma2, q1, q2)
...
def computeRab_node0(psi2l, q2, qr, X_xdelta, C0ab, *args):
    (component_names, num_nodes, component_nodes, component_father) = args

    qr0 = qr[0]
    qrx = qr[1:]
    Rab0 = (
        2 * jnp.tensordot(qrx, qrx, axes=0)
