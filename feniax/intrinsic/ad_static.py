import feniax.intrinsic.ad_common as ad_common
...
def main_10g11(
    ...
    (
        ...
        C0ab,
        C06ab,
    ) = _compute_modes(X, Ka, Ma, reduced_eigenvals, reduced_eigenvecs, config)
    ...
    dq_args = (gamma2, omega, phi1l, x_forceinterpol, y_forceinterpol)
    ...
    X2, X3, ra, Cab = isys.recover_staticfields(
        q2, tn, X, phi2l, psi2l, X_xdelta, C0ab, config.fem
    )
