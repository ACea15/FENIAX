...
alpha1 = np.load("/media/acea/work/projects/FEM4INAS/Models/ArgyrisFrame_20\
/Test/EndLoad/results_29-7-2023_18-18/Results_modes/alpha1_150.npy")

alpha2 = np.load("/media/acea/work/projects/FEM4INAS/Models/ArgyrisFrame_20\
/Test/EndLoad/results_29-7-2023_18-18/Results_modes/alpha2_150.npy")

with open ("/media/acea/work/projects/FEM4INAS/Models/ArgyrisFrame_20/Test/EndLoad/results_29-7-2023_18-18/Results_modes/Phil_150", 'rb') as fp:
    [phi0l,phi1l,phi1ml,phi2l,mphi1l,cphi2xl]  = pickle.load(fp)

with open ("/media/acea/work/projects/FEM4INAS/Models/ArgyrisFrame_20/Test/EndLoad/results_29-7-2023_18-18/Results_modes/Phi_150", 'rb') as fp:
