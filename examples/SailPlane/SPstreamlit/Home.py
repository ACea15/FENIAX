...
# st.divider()
# st.image('/Users/ac5015/projects/FENIAX.docs/reports/scitech24/figs/classes_architecture.png',
#          caption='Classes architecture')

# st.divider()
# st.image('/Users/ac5015/projects/FENIAX.docs/reports/oct23/img/aircraft_process.pdf',
#          caption='Aircraft process')

sti.home()
st.divider()

st.title("Sail Plane Aircraft")
sp_path = str(feniax.PATH / "../docs/images/SailPlane2.png")
#pdf_viewer(sp_path)
st.image(sp_path, caption="Aircraft FE model", use_column_width=False, width=550)
st.text("This is what we can do!!")
st.image(str(feniax.PATH / "../docs/images/SailPlane3D_front.png"),
