...
#+begin_src python 
  ...
  inp.systems.sett.s1.aero.c_ref = c_ref
  inp.systems.sett.s1.aero.u_inf = u_inf # a0(7000) =312
  inp.systems.sett.s1.aero.rho_inf = rho_inf
...
#+begin_src python :tangle ./settings_manoeuvre1shard.py :session *pyshard1*
  ...
  <<ManoeuvreMain>>
  inp.driver.sol_path = pathlib.Path(
      "./results1manoeuvreShard")  
  inputflow = dict(u_inf=[100., 150., 170, 190.],
                   rho_inf=[0.4, 0.6, 1., 1.2])
...
#+begin_src python :tangle settings_gust1shard.py :session *pyshard2*
  ...
  inp.driver.sol_path = pathlib.Path(
      f"./results1gust_{sol}Shard")
  inp.system.aero.gust.fixed_discretisation = [100, u_inf]
  # Shard inputs
  inputflow = dict(length=[30, 67],
                   intensity= [0.01, 0.08, 0.2, 0.7],
                   rho_inf = [rho_inf, rho_inf*1.1]
                 )
