...
#+begin_src python :session py1 :var output="num_modes" :results value :tangle generate_aero.py :noweb yes
  import numpy as np
...
* Modal Solution
#+begin_src org :tangle "./SOL103/run_caof.bdf" :mkdirp yes :noweb yes
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  $ EXECUTIVE CONTROL								      $
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
#+begin_src bash :mkdirp yes :shebang   #!/usr/bin/zsh -i :results none
  cd SOL103
  nastran run_cao.bdf
#+end_src
...
#+begin_src python :session py1  :results none :tangle generate_aero.py
  ...
  eigs, modes = op4handler.write_op4modes("./SOL103/run_caof",
                               num_modes,
...
#+begin_src org :noweb yes :tangle "./GAFs/run_cao.bdf" :mkdirp yes
  $EXECUTIVE CONTROL DECK
  assign OUTPUT4='../data_out/Qhh<<python_parameters()>>-<<python_parameters(output="num_modes")>>.op4',formatted,UNIT=11
...
#+begin_src python :session py1  :results none :noweb yes :tangle generate_aero.py
...
* COMMENT Qalpha GAFs extraction
...
* COMMENT DLM dihedral extraction
