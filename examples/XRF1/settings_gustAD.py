...
inp.system.aero.A = f"./AERO/AICs081_8r{inp.fem.num_modes}.npy"
inp.system.aero.D = f"./AERO/AICsQhj081_8r{inp.fem.num_modes}.npy"
inp.system.aero.poles = f"./AERO/Poles081_8r{inp.fem.num_modes}.npy"
...
inp.system.aero.gust.panels_dihedral = jnp.load("./AERO/Dihedral.npy")
inp.system.aero.gust.collocation_points = "./AERO/Control_nodes.npy"
node = 5
