...
# [[file:modelgen.org::*Build Nastran models][Build Nastran models:3]]
@dataclass
class Config:
    BAR: bool = False
    L: float = 1.
...
def build_bdf(config: Config):
    ...
    ############################
    return mesh
# Build Nastran models:3 ends here
...
# [[file:modelgen.org::*Read and save FEM and FENIAX grid][Read and save FEM and FENIAX grid:2]]
model_list= [8] #range(1, num_models + 1)
for i in model_list:
...
# [[file:modelgen.org::*Read and save FEM and FENIAX grid][Read and save FEM and FENIAX grid:3]]
...
# Read and save FEM and FENIAX grid:3 ends here
